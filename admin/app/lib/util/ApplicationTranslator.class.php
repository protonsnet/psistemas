...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['en'][] = 'Birth';
        $this->messages['en'][] = 'Welcome';
        $this->messages['en'][] = 'Register';
        $this->messages['en'][] = 'Financial Control';
        $this->messages['en'][] = 'Financial Release';
        $this->messages['en'][] = 'Check List Financial Entries';
        $this->messages['en'][] = 'Budget';
        $this->messages['en'][] = 'Budget Analyse Year';
        $this->messages['en'][] = 'Report';
        $this->messages['en'][] = 'List by Period';
        $this->messages['en'][] = 'Account Annual Summary';
        $this->messages['en'][] = 'Chart';
        $this->messages['en'][] = 'Accounts Title';
        $this->messages['en'][] = 'Category';
        $this->messages['en'][] = 'Subcategory';
        $this->messages['en'][] = 'Check List';
        $this->messages['en'][] = 'Account';
        $this->messages['en'][] = 'Access denied';
        $this->messages['en'][] = 'Confirm deletion?';
        $this->messages['en'][] = 'Successfully deleted record';
        $this->messages['en'][] = 'Plan';
        $this->messages['en'][] = 'Income';
        $this->messages['en'][] = 'Expense';
        $this->messages['en'][] = 'Type is mandatory';
        $this->messages['en'][] = 'Data is mandatory';
        $this->messages['en'][] = 'Account is mandatory';
        $this->messages['en'][] = 'Choose a category';
        $this->messages['en'][] = 'Choose a subcategory';
        $this->messages['en'][] = 'Description is mandatory';
        $this->messages['en'][] = 'Value is mandatory';
        $this->messages['en'][] = 'Date';
        $this->messages['en'][] = 'Value';
        $this->messages['en'][] = 'Repeat register';
        $this->messages['en'][] = 'Year';
        $this->messages['en'][] = 'Month';
        $this->messages['en'][] = 'Summary';
        $this->messages['en'][] = 'Budget Analyse Month';
        $this->messages['en'][] = 'Year/month';
        $this->messages['en'][] = 'Chart type';
        $this->messages['en'][] = 'Forecast';
        $this->messages['en'][] = 'Programmed';
        $this->messages['en'][] = 'Current';
        $this->messages['en'][] = 'Diferrence';
        $this->messages['en'][] = 'Balance';
        $this->messages['en'][] = 'Confirm';
        $this->messages['en'][] = 'Simulated';
        $this->messages['en'][] = 'Summation';
        $this->messages['en'][] = 'Budget Analysis Chart';
        $this->messages['en'][] = 'Line';
        $this->messages['en'][] = 'Pie';
        ...
        $this->messages['en'][] = 'Repeat';
        $this->messages['en'][] = 'Consult';
        $this->messages['en'][] = 'Days';
        $this->messages['en'][] = 'Region';
        $this->messages['en'][] = 'ID is mandatory';
        $this->messages['en'][] = 'Payment link';
        $this->messages['en'][] = 'Allow renew';
        $this->messages['en'][] = 'Free days';
        $this->messages['en'][] = 'Representation';
        $this->messages['en'][] = 'Expires';
        $this->messages['en'][] = 'Renew plan';
        $this->messages['en'][] = 'Does not expire';
        $this->messages['en'][] = 'Actions';
        $this->messages['en'][] = 'Indication';
        $this->messages['en'][] = 'Your license expires';
        $this->messages['en'][] = 'Session expire';
        ...
        $this->messages['en'][] = 'Receive payment';
        $this->messages['en'][] = 'Amount';
        $this->messages['en'][] = 'Next Date';
        $this->messages['en'][] = 'Paid out';
        $this->messages['en'][] = 'No payment';
        ...
        $this->messages['pt'][] = 'Controle Financeiro';
        $this->messages['pt'][] = 'Lançamento Financeiro';
        $this->messages['pt'][] = 'Lista de Verificação de Lançamentos';
        $this->messages['pt'][] = 'Orçamento';
        $this->messages['pt'][] = 'Análise orçamentária anual';
        $this->messages['pt'][] = 'Relatório';
        $this->messages['pt'][] = 'Relatório por Período';
        $this->messages['pt'][] = 'Resumo anual';
        $this->messages['pt'][] = 'Gráfico';
        $this->messages['pt'][] = 'Título da conta';
        $this->messages['pt'][] = 'Categoria';
        $this->messages['pt'][] = 'Subcategoria';
        $this->messages['pt'][] = 'Lista de verificação';
        $this->messages['pt'][] = 'Conta';
        $this->messages['pt'][] = 'Acesso negado';
        $this->messages['pt'][] = 'Confirma exclusão';
        $this->messages['pt'][] = 'Registro excluído com sucesso';
        $this->messages['pt'][] = 'Plano';
        $this->messages['pt'][] = 'Renda';
        $this->messages['pt'][] = 'Despesa';
        $this->messages['pt'][] = 'Tipo obrigatório';
        $this->messages['pt'][] = 'Dados são obrigatórios';
        $this->messages['pt'][] = 'A conta é obrigatória';
        $this->messages['pt'][] = 'Escolha uma categoria';
        $this->messages['pt'][] = 'Escolha uma subcategoria';
        $this->messages['pt'][] = 'A descrição é obrigatória';
        $this->messages['pt'][] = 'Valor é obrigatório';
        $this->messages['pt'][] = 'Data';
        $this->messages['pt'][] = 'Valor';
        $this->messages['pt'][] = 'Repetir registro';
        $this->messages['pt'][] = 'Ano';
        $this->messages['pt'][] = 'Mês';
        $this->messages['pt'][] = 'Sumário';
        $this->messages['pt'][] = 'Mês de análise do orçamento';
        $this->messages['pt'][] = 'Ano/mês';
        $this->messages['pt'][] = 'Tipo de gráfico';
        $this->messages['pt'][] = 'Previsão';
        $this->messages['pt'][] = 'Programado';
        $this->messages['pt'][] = 'Atual'; 
        $this->messages['pt'][] = 'Diferença';
        $this->messages['pt'][] = 'Saldo';
        $this->messages['pt'][] = 'Confirmar';
        $this->messages['pt'][] = 'Simulado';
        $this->messages['pt'][] = 'Resumo';
        $this->messages['pt'][] = 'Gráfico de análise orçamentária';
        $this->messages['pt'][] = 'Linha';
        $this->messages['pt'][] = 'Pizza';
        ...
        $this->messages['pt'][] = 'Repetir';
        $this->messages['pt'][] = 'Consultar';
        $this->messages['pt'][] = 'Dias';
        $this->messages['pt'][] = 'Região';
        $this->messages['pt'][] = 'ID é obrigatório';
        $this->messages['pt'][] = 'Link de pagamento';
        $this->messages['pt'][] = 'Permitir renovação';
        $this->messages['pt'][] = 'Dias gratuitos';
        $this->messages['pt'][] = 'Representação';
        $this->messages['pt'][] = 'Expira';
        $this->messages['pt'][] = 'Renovar plano';
        $this->messages['pt'][] = 'Não expira';
        $this->messages['pt'][] = 'Ações';
        $this->messages['pt'][] = 'Indicação';
        $this->messages['pt'][] = 'Sua licença expira';
        $this->messages['pt'][] = 'Sessão expira';
        ...
        $this->messages['pt'][] = 'Status do pagamento';
        $this->messages['pt'][] = 'Receber pagamento';
        $this->messages['pt'][] = 'Valor';
        $this->messages['pt'][] = 'Próxima Data';
        $this->messages['pt'][] = 'Pago';
        $this->messages['pt'][] = 'Em aberto';
        ...
        $this->messages['es'][] = 'Complementar';
        $this->messages['es'][] = 'Vecindario';
        $this->messages['es'][] = 'Ciudad';
        $this->messages['es'][] = 'Estado';
        $this->messages['es'][] = 'Nacimiento';
        $this->messages['es'][] = 'Bienvenido';
        $this->messages['es'][] = 'Registro';
        $this->messages['es'][] = 'Control Financiero';
        $this->messages['es'][] = 'Comunicado financiero';
        $this->messages['es'][] = 'Lista de verificación de entradas';
        $this->messages['es'][] = 'Presupuesto';
        $this->messages['es'][] = 'Análisis del presupuesto anual';
        $this->messages['es'][] = 'Reportar';
        $this->messages['es'][] = 'Lista por período';
        $this->messages['es'][] = 'Resumen anual de la cuenta';
        $this->messages['es'][] = 'Gráfico';
        $this->messages['es'][] = 'Título de cuentas';
        $this->messages['es'][] = 'Categoría';
        $this->messages['es'][] = 'Subcategoría';
        $this->messages['es'][] = 'Lista de verificación';
        $this->messages['es'][] = 'Cuenta';
        $this->messages['es'][] = 'Acceso denegado';
        $this->messages['es'][] = '¿Confirmar la eliminación?';
        $this->messages['es'][] = 'Registro eliminado exitosamente';
        $this->messages['es'][] = 'Plan';
        $this->messages['es'][] = 'Ingresos';
        $this->messages['es'][] = 'Gasto';
        $this->messages['es'][] = 'El tipo es obligatorio';
        $this->messages['es'][] = 'Los datos son obligatorios';
        $this->messages['es'][] = 'La cuenta es obligatoria';
        $this->messages['es'][] = 'Elija una categoría';
        $this->messages['es'][] = 'Elegir una subcategoría';
        $this->messages['es'][] = 'La descripción es obligatoria';
        $this->messages['es'][] = 'El valor es obligatorio';
        $this->messages['es'][] = 'Fecha';
        $this->messages['es'][] = 'Valor';
        $this->messages['es'][] = 'Repetir registro';
        $this->messages['es'][] = 'Año';
        $this->messages['es'][] = 'Mes';
        $this->messages['es'][] = 'Resumen';
        $this->messages['es'][] = 'Mes de análisis del presupuesto';
        $this->messages['es'][] = 'Año/mes';
        $this->messages['es'][] = 'Tipo de gráfico';
        $this->messages['es'][] = 'Pronóstico';
        $this->messages['es'][] = 'Programado';
        $this->messages['es'][] = 'Actual';
        $this->messages['es'][] = 'Diferencia';
        $this->messages['es'][] = 'Saldo';
        $this->messages['es'][] = 'Confirmar';
        $this->messages['es'][] = 'Simulado';
        $this->messages['es'][] = 'Resumen';
        $this->messages['es'][] = 'Gráfico de análisis presupuestario';
        $this->messages['es'][] = 'Línea';
        $this->messages['es'][] = 'Pizza';
        $this->messages['es'][] = 'Actualizar';
        $this->messages['es'][] = 'Fecha inicial';
        $this->messages['es'][] = 'Fecha final';
        $this->messages['es'][] = 'Crédito';
        $this->messages['es'][] = 'Débito';
        $this->messages['es'][] = 'Repetir';
        $this->messages['es'][] = 'Consultar';
        $this->messages['es'][] = 'Días';
        $this->messages['es'][] = 'Región';
        $this->messages['es'][] = 'El ID es obligatorio';
        $this->messages['es'][] = 'Enlace de pago';
        $this->messages['es'][] = 'Permitir renovar';
        $this->messages['es'][] = 'Días libres';
        $this->messages['es'][] = 'Representación';
        $this->messages['es'][] = 'Expira';
        $this->messages['es'][] = 'Renovar plan';
        $this->messages['es'][] = 'No caduca';
        $this->messages['es'][] = 'Acciones';
        $this->messages['es'][] = 'Indicación';
        $this->messages['es'][] = 'Su licencia caduca';
        $this->messages['es'][] = 'La sesión expira';
        $this->messages['es'][] = 'Financiero';
        $this->messages['es'][] = 'Fecha de vencimiento';
        $this->messages['es'][] = 'Fecha de pago';
        $this->messages['es'][] = 'Pago';
        $this->messages['es'][] = 'Estado de pago';
        $this->messages['es'][] = 'Recibir pago';
        $this->messages['es'][] = 'Cantidad';
        $this->messages['es'][] = 'Próxima fecha';
        $this->messages['es'][] = 'Pagado';
        $this->messages['es'][] = 'Sin pago';
        $this->messages['es'][] = 'Imagen';
        //fim
